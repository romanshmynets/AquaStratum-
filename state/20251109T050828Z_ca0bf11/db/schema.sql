...
ALTER SCHEMA "introspect" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "introspect"."columns"() RETURNS TABLE("schema_name" "text", "table_name" "text", "column_name" "text", "data_type" "text", "is_nullable" "text", "ordinal" integer)
    LANGUAGE "sql" STABLE
    AS $$
                                          select
                                              c.table_schema,
...
ALTER FUNCTION "introspect"."columns"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "introspect"."fks"() RETURNS TABLE("schema_name" "text", "table_name" "text", "column_name" "text", "ref_schema" "text", "ref_table" "text", "ref_column" "text", "ordinal" integer)
    LANGUAGE "sql" STABLE
    AS $$
                                                                                                                                        select
                                                                                                                                            src_tc.table_schema              as schema_name,
                                                                                                                                                src_tc.table_name                as table_name,
                                                                                                                                                    src_kcu.column_name              as column_name,
                                                                                                                                                        tgt_tc.table_schema              as ref_schema,
                                                                                                                                                            tgt_tc.table_name                as ref_table,
                                                                                                                                                                tgt_kcu.column_name              as ref_column,
                                                                                                                                                                    src_kcu.position_in_unique_constraint::int as ordinal
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          and tgt_kcu.constraint_schema = tgt_tc.constraint_schema
                                                                                                                                                                                                             and tgt_kcu.ordinal_position = src_kcu.position_in_unique_constraint
                                                                                                                                                                                                               where src_tc.constraint_type = 'FOREIGN KEY'
                                                                                                                                                                                                                   and src_tc.table_schema not in ('pg_catalog','information_schema')
                                                                                                                                                                                                                     order by 1,2,7
                                                                                                                                                                                                                     $$;


ALTER FUNCTION "introspect"."fks"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "introspect"."indexes"() RETURNS TABLE("schema_name" "text", "table_name" "text", "index_name" "text", "column_name" "text", "is_unique" boolean, "is_primary" boolean, "ordinal" integer)
    LANGUAGE "sql" STABLE
    AS $$
                                                                                                                                                                                                                                     with idx as (
                                                                                                                                                                                                                                         select
                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                           i.relname                                       as index_name,
                                                                                                                                                                                                                                                                 ix.indisunique                                  as is_unique,
                                                                                                                                                                                                                                                                       ix.indisprimary                                 as is_primary,
                                                                                                                                                                                                                                                                             ix.indkey                                       as indkey,
                                                                                                                                                                                                                                                                                   generate_subscripts(ix.indkey,1)                as pos
                                                                                                                                                                                                                                                                                       from pg_index ix
                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                               idx.is_unique,
                                                                                                                                                                                                                                                                                                                                                                   idx.is_primary,
                                                                                                                                                                                                                                                                                                                                                                       idx.pos    as ordinal
                                                                                                                                                                                                                                                                                                                                                                         from idx
                                                                                                                                                                                                                                                                                                                                                                           join cols c
                                                                                                                                                                                                                                                                                                                                                                               on c.attrelid = (select oid from pg_class where relname = idx.table_name
                                                                                                                                                                                                                                                                                                                                                                                                    and relnamespace = (select oid from pg_namespace where nspname = idx.schema_name))
                                                                                                                                                                                                                                                                                                                                                                                                       and c.attnum = idx.indkey[idx.pos]
                                                                                                                                                                                                                                                                                                                                                                                                         order by 1,2,3,7
                                                                                                                                                                                                                                                                                                                                                                                                         $$;


ALTER FUNCTION "introspect"."indexes"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "introspect"."pks"() RETURNS TABLE("schema_name" "text", "table_name" "text", "column_name" "text", "ordinal" integer)
    LANGUAGE "sql" STABLE
    AS $$
                                                                                  select
                                                                                      tc.table_schema,
...
ALTER FUNCTION "introspect"."pks"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "introspect"."tables"() RETURNS TABLE("schema_name" "text", "table_name" "text")
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "introspect"."tables"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "introspect"."views"() RETURNS TABLE("schema_name" "text", "view_name" "text")
    LANGUAGE "sql" STABLE
    AS $$
                      select table_schema, table_name
...
ALTER FUNCTION "introspect"."views"() OWNER TO "postgres";
...
GRANT USAGE ON SCHEMA "introspect" TO "anon";
GRANT USAGE ON SCHEMA "introspect" TO "authenticated";
GRANT USAGE ON SCHEMA "introspect" TO "service_role";
...
GRANT ALL ON FUNCTION "introspect"."columns"() TO "anon";
GRANT ALL ON FUNCTION "introspect"."columns"() TO "authenticated";
GRANT ALL ON FUNCTION "introspect"."columns"() TO "service_role";



GRANT ALL ON FUNCTION "introspect"."fks"() TO "anon";
GRANT ALL ON FUNCTION "introspect"."fks"() TO "authenticated";
GRANT ALL ON FUNCTION "introspect"."fks"() TO "service_role";



GRANT ALL ON FUNCTION "introspect"."indexes"() TO "anon";
GRANT ALL ON FUNCTION "introspect"."indexes"() TO "authenticated";
GRANT ALL ON FUNCTION "introspect"."indexes"() TO "service_role";



GRANT ALL ON FUNCTION "introspect"."pks"() TO "anon";
GRANT ALL ON FUNCTION "introspect"."pks"() TO "authenticated";
GRANT ALL ON FUNCTION "introspect"."pks"() TO "service_role";



GRANT ALL ON FUNCTION "introspect"."tables"() TO "anon";
GRANT ALL ON FUNCTION "introspect"."tables"() TO "authenticated";
GRANT ALL ON FUNCTION "introspect"."tables"() TO "service_role";



GRANT ALL ON FUNCTION "introspect"."views"() TO "anon";
GRANT ALL ON FUNCTION "introspect"."views"() TO "authenticated";
GRANT ALL ON FUNCTION "introspect"."views"() TO "service_role";
...
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "introspect" GRANT ALL ON FUNCTIONS TO "postgres";
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "introspect" GRANT ALL ON FUNCTIONS TO "anon";
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "introspect" GRANT ALL ON FUNCTIONS TO "authenticated";
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "introspect" GRANT ALL ON FUNCTIONS TO "service_role";
